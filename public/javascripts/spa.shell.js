...
spa.shell = (function () {
  ...
  var
    ...
    onResize,         onHashchange,   setChatAnchor, initModule;
 ...
 // Begin DOM method /changeAnchorPart/
  ...
  onHashchange = function ( event ) {
    ...
    switch ( s_chat_proposed ) {
      case 'opened' :
        is_ok = spa.conversation_form.setSliderPosition( 'opened' );
      break;
      case 'closed' :
        is_ok = spa.conversation_form.setSliderPosition( 'closed' );
      break;
      default :
        spa.conversation_form.setSliderPosition( 'opened' );
  ...
  onResize = function () {
    ...
    spa.conversation_form.handleResize();
  ...
  initModule = function ( $container ) {
    ...
    spa.conversation_form.configModule({
      set_chat_anchor       : setChatAnchor,
      conversation_model    : spa.model.conversation
    });

    spa.sound.initModule();
    spa.sidebar.initModule( jqueryMap.$sidebar  );
    spa.conversation_form.initModule( jqueryMap.$container );
    spa.conversation_items.initModule( jqueryMap.$container  );
    
    spa.call_modal.initModule( jqueryMap.$container );
