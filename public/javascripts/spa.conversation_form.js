...
spa.conversation_form = (function () {
  'use strict';
  //---------------- BEGIN MODULE SCOPE VARIABLES --------------
  var
    configMap = {
      main_html : Handlebars.compile($('#spa-conversation-module').html()),
  ...
  setJqueryMap = function () {
    var
      ...
      $slider        = $append_target.find( '#spa-conversation-form' );
    ...
    jqueryMap = {
      ...
      $convo_desc     : $slider.find( '.spa-conversation-description'),
  ...
  onSubmitMsg = function ( event ) {
    var data = {
      ...
      "convo_desc"  : jqueryMap.$convo_desc.val()
    };
