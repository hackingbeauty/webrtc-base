  ...
  connect : function ( server ) {
    ...
    io
      .sockets.on( 'connection', function ( socket ) {
        ...
        socket.on( 'join request', function ( conversation ) {
          console.log('SENDING A REQUEST TO JOIN, and conversationName is ', conversation);
          io.sockets.emit('join request broadcast', conversation);
        });

        socket.on( 'cancel conversation offer', function ( conversation ) {
          console.log('CANCELLING AN OFFER ', conversation);
          io.sockets.emit('cancel conversation offer broadcast', conversation);
        });
